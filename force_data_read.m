function [Force] = force_data_read(path)
%FORCE_DATA_READ Reads raw force data and returns force struct
%   Ensure that the current directory contains the desired force xlsx files
%   Copied from the original file 'Step02_Force.m'
